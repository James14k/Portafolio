...
import { FaMicrochip, FaCloud, FaDatabase, FaCode, FaCoffee } from 'react-icons/fa';
    ...
    <div className="container-fluid py-5" id="skill">
      <div className="container">
        <div className="position-relative d-flex align-items-center justify-content-center">
          ...
          <h1 className="position-absolute text-uppercase text-primary" style={{ fontSize: 'clamp(1.25rem, 3vw, 2.5rem)' }}>Habilidades Destacadas</h1>
        </div>
        <div className="row align-items-center">
          <section className="skills" id="skills">
            <ul className="skills-list">
              {skills.map((skill, index) => (
                <li key={index} className="skills-skill" style={{ 
                  display: 'flex', 
                  ...
                  <span style={{ fontSize: 'clamp(0.75rem, 2vw, 0.875rem)', fontWeight: 500, textAlign: 'center', wordBreak: 'break-word' }}>
                    {skill.name}
                  </span>
                </li>
              ))}
